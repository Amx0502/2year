...
export default {
  data() {
    return {
      ...
      fontLoaded: false,
      textLines: [
        { text: "top1是你。", speaker: "我说", fontSize: '23px', marginTop: '15px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
        { text: "哦？这么直白", speaker: "她疑惑问", fontSize: '23px', marginTop: '0px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
        { text: "打直球好吧，之前说的那些，其实都不算最特别的——真正让我记一辈子的，不是某件事，是你。", speaker: "我", fontSize: '23px', marginTop: '0px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
        { text: "我有时候会闹脾气，会说你骂你，都没关系吗？", speaker: "她说", fontSize: '23px', marginTop: '0px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
        { text: "没有你，再精彩的事都没意义；有了你，哪怕只是坐在一起发呆，都是我最珍贵的时刻。", speaker: "我", fontSize: '23px', marginTop: '0px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
        { text: "你!!!就是我的top1", speaker: "我", fontSize: '23px', marginTop: '0px', marginBottom: '10px', paddingLeft: '40px', paddingRight: '0px' },
      ],
      displayedTextLines: [],
      cursorInterval: null,
      // Canvas绘制Y相关状态
  ...
  methods: {
    ...
    drawTemplateY() {
      ...
      const yWidth = Math.min(canvas.width, canvas.height) * 0.25
